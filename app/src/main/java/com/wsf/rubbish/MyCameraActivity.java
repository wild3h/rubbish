        ...
        new Thread(new Runnable(){
            ...
            public void run() {
                ...
                try {
                    ...
                    for (int i=0;i<new Integer(res.getString("result_num"));i++){
                        if(new Double(res.getJSONArray("result").getJSONObject(i).getDouble("score"))>=0.1){
                            list.add(res.getJSONArray("result").getJSONObject(i).getString("keyword"));
                        }
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
